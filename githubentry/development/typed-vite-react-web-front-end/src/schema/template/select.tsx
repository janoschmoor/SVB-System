...
import { Alert, Badge, Button, FormControl, FormGroup, FormSelect, InputGroup } from "react-bootstrap";
...
export default function SelectTemplate(props: 
                ...
                <Form noValidate onSubmit={(e) => {e.preventDefault(); startPropagation()}}>
                    <FormGroup>
                        <InputGroup>
                            ...
                            >
                                {props.schema.options.map((option: any) => {
                                    return (
    ...
    return (
        <div onClick={(e: any) => {
            ...
            {getLabel()}{<Badge bg={props.schema.options.find((o: any) => o.key == localData)?.variant}>{props.schema.options.find((o: any) => o.key == localData)?.display}</Badge>}
        </div>
    );
