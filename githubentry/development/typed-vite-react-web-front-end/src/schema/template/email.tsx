...
export default function EmailTemplate(props: 
    ...
    const isValid = () => {
        ...
        const valid = (typeof localData === "string" && emailRegex.test(localData));
        return valid;
    }
    ...
    const startPropagation = () => {
        if ((inputIsValid && (hasChanges || props.data == undefined)) || props.data == undefined) {
                    ...
                    <FormGroup>
                        <InputGroup>
                            ...
                            <FormControl
                                ...
                                />
                            {
                                <Button onClick={() => {startPropagation()}} variant={"primary"}>
                                    Suchen
                                </Button>
                            }                            
                        </InputGroup>
