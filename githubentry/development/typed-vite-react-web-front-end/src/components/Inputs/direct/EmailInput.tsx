...
export default function EmailInput(props: {
    ...
    return (
        <FormGroup className={!props.forceDirect ? "INPUTGROUP" : ""} data-key={props.keyName} data-formid={props.formId} data-type="email" data-haschange={hasChange} data-value={value} data-text={getCurrentTextAsString()}>
...
export const EvaluateEmail = (input: any) => {
    return input.value;
}