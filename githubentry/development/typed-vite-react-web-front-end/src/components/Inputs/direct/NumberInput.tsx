...
export default function NumberInput(props: {
    ...
    return (
        <FormGroup className={!props.forceDirect ? "INPUTGROUP" : ""} data-key={props.keyName} data-formid={props.formId} data-type="number" data-haschange={hasChange} data-value={value} data-text={getCurrentTextAsString()}>
...
export const EvaluateNumber = (input: any) => {
