...
import { ICourse } from "./helper/interfaces";
...
export const PlanCourses = functions.https.onCall((data, context) => {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            if (!CalendarRef.exists || !CourseInstructionsRef.exists || !CourseTemplatesRef.exists) {
                ...
                reject({
                    ...
                    error: "Calendar or CourseInstructions or CourseTemplates not found!" + "logs/" + GENID,
                });
                return;
            }
...
const instanciateCourse = (courseInstruction: any, courseTemplates: any, calendar: any, id:string | null, genId: string) => {
    ...
    while ( absoluteTime < newCourse.end.toDate() && iteration < 60) {
